    ...
    fetch(URL + '/' + id, {
        ...
        res.json()
            .then(userEdit => {
                ...
                document.getElementById('editModalFirstName').value = userEdit.firstName;
                document.getElementById('editModalLastName').value = userEdit.lastName;
                document.getElementById('editModalAge').value = userEdit.age;
...
function editUser() {
    ...
    let firstName = document.getElementById('editModalFirstName').value;
    let lastName = document.getElementById('editModalLastName').value;
    let age = document.getElementById('editModalAge').value;
...
function getDeleteModal(id) {
    fetch(URL + '/' + id, {
        ...
        res.json().then(userDelete => {
            ...
            document.getElementById('deleteModalFirstName').value = userDelete.firstName;
            document.getElementById('deleteModalLastName').value = userDelete.lastName;
            document.getElementById('deleteModalAge').value = userDelete.age;
